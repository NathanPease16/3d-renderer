...
def main():
    ...
    for coordinate in coordinates_2D:
        ...
        if x > x_bounds[0] and x < x_bounds[1] and y > y_bounds[0] and y < y_bounds[1]:
            print(coordinate)
            render_coordinates.pop(coordinates_2D.index(coordinate))
            coordinates_2D.remove(coordinate)
    ...
    for coordinate in coordinates_2D:
        ...
        vertices = connectedVerticies(render_coordinates[coordinates_2D.index(coordinate)])
